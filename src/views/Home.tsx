...
// import { useWalkthroughStep } from 'react-native-interactive-walkthrough';
// import { WalkthroughOverlay } from '../components/WalkthroughOverlay';
// import { TabBarIcon } from '@react-navigation/bottom-tabs'; // You may need to adjust this import
...
//   const activityRef = useRef<View>(null) as ViewRef;
//   const featuresRef = useRef<View>(null) as ViewRef;
//   const profileTabRef = useRef<View>(null) as ViewRef; // Ref for the profile tab
...
//   // Profile Tab Step - This will be the first step to guide users to their profile
//   const {
//     onLayout: profileTabOnLayout,
//     onMeasure: profileTabOnMeasure
//   } = useWalkthroughStep({
//     identifier: 'profile-tab',
//     number: 1, // Making this the first step
//     measureMask: () => ({
//       x: width * 0.66, // Position for the profile tab (third tab)
//       y: height - 60,  // Bottom tab bar position
//       width: width * 0.33,
//       height: 60,
//       borderRadius: 0,
//       allowInteraction: true
...
//   // Recent Activity Step (now step 4)
//   const {
//     onLayout: activityOnLayout,
//     onMeasure: activityOnMeasure
//   } = useWalkthroughStep({
...
//       {/* This is a fake tab bar item for the walkthrough to highlight */}
//       {/* In a real app, you would need to get a reference to the actual tab bar item */}
//       <View
//         ref={profileTabRef}
//         onLayout={(e) => handleLayout(e, profileTabRef, profileTabOnLayout, profileTabOnMeasure)}
//         style={{
//           position: 'absolute',
//           left: width * 0.66,
//           bottom: 0,
